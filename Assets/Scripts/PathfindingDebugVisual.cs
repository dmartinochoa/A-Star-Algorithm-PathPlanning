...
public class PathfindingDebugVisual : MonoBehaviour
{
    ...
    public void Setup(GridSystem<PathNode> grid)
    {
    ...
    public void TakeSnapshot(GridSystem<PathNode> grid, PathNode current, List<PathNode> openList, List<PathNode> closedList)
    {
    ...
    public void TakeSnapshotFinalPath(GridSystem<PathNode> grid, List<PathNode> path)
    {
        GridSnapshotAction gridSnapshotAction = new GridSnapshotAction();
        gridSnapshotAction.AddAction(HideNodeVisuals);
